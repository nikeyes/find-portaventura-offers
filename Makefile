...
# FILE_HOTELS=downloaded_data/hotels_$(TODAY_WITHOUT_DASHES)_a3_c2_7_11.json
...
# poetry run python src/main.py download-rates --date-ini $(TODAY) --date-end $(DATE_END) --adults 3 --children 2 --children-ages 7,11
