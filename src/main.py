...
def download_rates(date_ini: datetime, date_end: datetime, children: int, children_ages: str, adults: int):
...
def find_offers(hotel_prices: str, ticket_prices: str, date_ini: datetime, date_end: datetime, emails: str, max_offers: int) -> None:
    find_offers_instance = FindOffers(
        hotel_prices_file=hotel_prices, ticket_prices_file=ticket_prices, date_ini=date_ini, date_end=date_end, max_offers=max_offers
    )
